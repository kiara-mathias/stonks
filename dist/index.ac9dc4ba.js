...
function calculateProfitandLoss(initial, quantity, current) {
    if (initial > current) {
        ...
        colorChange("red");
        showOutput(`Oops your in loss of ${loss} and your loss percentage is ${lossPercentage}%`);
    } else if (current > initial) {
        var profit = current - initial;
        var profitPercentage = profit / initial * 100;
        profitPercentage = parseInt(profitPercentage, 10);
        colorChange("green");
        showOutput(`YOUR IN PROFIT OF ${profit} and profit percentage is ${profitPercentage}%`);
        console.log("profit");
    } else {
